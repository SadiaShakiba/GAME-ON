...
public class GameConfirmation03 implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        yesBtn3.setVisible(false);
        loadingScreen03 = new LoadingScreen(progressIndicator, loadingText,yesBtn3);
        Thread thread = new Thread(loadingScreen03);
...
class LoadingScreen03 implements Runnable {

    ProgressIndicator progressIndicator;
    Text loadingText;
    Button yesBtn3;

    public LoadingScreen03(ProgressIndicator progressIndicator, Text loadingText, Button yesBtn3) {
        this.progressIndicator = progressIndicator;
        this.loadingText = loadingText;
        this.yesBtn3=yesBtn3;
    }
