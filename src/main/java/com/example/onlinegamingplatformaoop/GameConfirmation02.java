...
public class GameConfirmation02 implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        yesBtn2.setVisible(false);
        LoadingScreen02 = new LoadingScreen(progressIndicator, loadingText,yesBtn2);
        Thread thread = new Thread(LoadingScreen02);
...
class LoadingScreen02 implements Runnable {

    ProgressIndicator progressIndicator;
    Text loadingText;
    Button yesBtn2;

    public LoadingScreen02(ProgressIndicator progressIndicator, Text loadingText, Button yesBtn2) {
        this.progressIndicator = progressIndicator;
        this.loadingText = loadingText;
        this.yesBtn2=yesBtn2;
    }
