...
public class GameConfirmation implements Initializable {
    @FXML
    ...
    @FXML
    private Button yesBtn2;
    @FXML
    private Button yesBtn3;
    @FXML
    ...
    @FXML
    private void Btn_yes(ActionEvent event) throws IOException, SQLException {
        if (event.getSource()==yesBtn){
            ...
            if(total_coins==0){
                ...
                Parent root = FXMLLoader.load(getClass().getResource("TicTacToeFront.fxml"));
                Stage stage = ((Stage)((Node)event.getSource()).getScene().getWindow());
    ...
    @FXML
    private void Btn_yes2(ActionEvent event) throws IOException, SQLException {
        if (event.getSource()==yesBtn2){
            try{
            ...
            if(total_coins==0){
                ...
                Parent root = FXMLLoader.load(getClass().getResource("flappy_front.fxml"));
                Stage stage = ((Stage)((Node)event.getSource()).getScene().getWindow());
                Scene scene = new Scene(root,600,400);
                stage.setX(500);
                stage.setY(120);
    ...
    @FXML
    private void Btn_yes3(ActionEvent event) throws IOException, SQLException {
        if (event.getSource()==yesBtn3){
            try{
                BufferedReader bufferedReader = new BufferedReader(new FileReader("C:/Users/USER/IdeaProjects/OnlineGamingPlatformAoop/Storage/temp_file.txt"));
                String[] check_line= {};
                String line= bufferedReader.readLine();
            ...
            if(total_coins==0){
                ...
                Parent root = FXMLLoader.load(getClass().getResource("memory_front.fxml"));
                Stage stage = ((Stage)((Node)event.getSource()).getScene().getWindow());
                Scene scene = new Scene(root,600,400);
                stage.setX(500);
                stage.setY(120);
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        loadingScreen = new LoadingScreen(progressIndicator, loadingText,yesBtn);
 ...
 class LoadingScreen implements Runnable {
    ...
    public LoadingScreen(ProgressIndicator progressIndicator, Text loadingText, Button yesBtn) {
